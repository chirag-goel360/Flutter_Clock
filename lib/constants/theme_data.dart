...
class CustomColors {
  ...
  static Color clockBackground = Color(0xFF444974);
  static Color transparent = Colors.transparent;
  static Color blueColor = Colors.blue;
  static Color clockOutline = Color(0xFFEAECFF);
  static Color secondHandColor = Colors.orange[300];
  static Color minuteHandStartColor = Color(0xFF748EF6);
  static Color minuteHandEndColor = Color(0xFF77DDFF);
  static Color hourHandStartColor = Color(0xFFC279FB);
